...
b_ = tree.amda.Parameters.Wind.MFI.wnd_mfi_kp.wnd_bmag
n_ = tree.amda.Parameters.Wind.SWE.wnd_swe_kp.wnd_swe_n
vth_ = tree.amda.Parameters.Wind.SWE.wnd_swe_kp.wnd_swe_vth
...
class WindBeta(DataProvider):
    ...
    def get_data(self, metadata, start, stop):
        ...
        bnt = pds.concat([b.to_dataframe(), n.to_dataframe(),
                          vth.to_dataframe()])
